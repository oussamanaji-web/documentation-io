<template>
    <div>
        ...
        <form v-on:submit.prevent="submitForm" class="mt-4">
            <div class="mb-3">
                <label for="backTitle" class="form-label">Titre</label>
                <input type="text" v-model="form.backTitle" class="form-control" id="backTitle"
                       placeholder="Title de la classe PHP">
            </div>
            <div class="mb-3">
                <label for="Description" class="form-label">Description</label>
                <textarea class="form-control" v-model="form.backDescription" id="Description" placeholder="Description"
                          rows="3"></textarea>
            </div>
            <div class="mb-3">
                <label for="backSourceCode" class="form-label">Code Source</label>
                <textarea class="form-control" v-model="form.backSourceCode" id="backSourceCode" placeholder="Code Source"
                          rows="6"></textarea>
            </div>
            <div class="mb-3">
...
export default {
    ...
    data() {
        return {
            form: {
                backTitle: this.documentation.backTitle,
                backDescription: this.documentation.backDescription,
                backSourceCode: this.documentation.backSourceCode,
            },
            status: false,
        }
    },
